 ...
 */
public class ResourceDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.java.dev.wadl.x2009.x02.ResourceDocument
{
     ...
     */
    public net.java.dev.wadl.x2009.x02.ResourceDocument.Resource getResource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.java.dev.wadl.x2009.x02.ResourceDocument.Resource target = null;
            target = (net.java.dev.wadl.x2009.x02.ResourceDocument.Resource)get_store().find_element_user(RESOURCE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setResource(net.java.dev.wadl.x2009.x02.ResourceDocument.Resource resource)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (net.java.dev.wadl.x2009.x02.ResourceDocument.Resource)get_store().add_element_user(RESOURCE$0);
            }
            target.set(resource);
        }
    }
     ...
     * This is a complex type.
     */
    public static class ResourceImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.java.dev.wadl.x2009.x02.ResourceDocument.Resource
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName QUERYTYPE$12 = 
            new javax.xml.namespace.QName("", "queryType");
        ...
        public java.util.List<net.java.dev.wadl.x2009.x02.DocDocument.Doc> getDocList()
        {
            final class DocList extends java.util.AbstractList<net.java.dev.wadl.x2009.x02.DocDocument.Doc>
            {
                public net.java.dev.wadl.x2009.x02.DocDocument.Doc get(int i)
                    { return ResourceImpl.this.getDocArray(i); }
                
                public net.java.dev.wadl.x2009.x02.DocDocument.Doc set(int i, net.java.dev.wadl.x2009.x02.DocDocument.Doc o)
                {
                    net.java.dev.wadl.x2009.x02.DocDocument.Doc old = ResourceImpl.this.getDocArray(i);
                    ResourceImpl.this.setDocArray(i, o);
                    return old;
                }
                
                public void add(int i, net.java.dev.wadl.x2009.x02.DocDocument.Doc o)
                    { ResourceImpl.this.insertNewDoc(i).set(o); }
                
                public net.java.dev.wadl.x2009.x02.DocDocument.Doc remove(int i)
                {
                    net.java.dev.wadl.x2009.x02.DocDocument.Doc old = ResourceImpl.this.getDocArray(i);
                    ResourceImpl.this.removeDoc(i);
                    return old;
                }
                
                public int size()
                    { return ResourceImpl.this.sizeOfDocArray(); }
        ...
        public java.util.List<net.java.dev.wadl.x2009.x02.ParamDocument.Param> getParamList()
        {
            final class ParamList extends java.util.AbstractList<net.java.dev.wadl.x2009.x02.ParamDocument.Param>
            {
                ...
                {
                    net.java.dev.wadl.x2009.x02.ParamDocument.Param old = ResourceImpl.this.getParamArray(i);
        ...
        public java.util.List<net.java.dev.wadl.x2009.x02.MethodDocument.Method> getMethodList()
        {
            final class MethodList extends java.util.AbstractList<net.java.dev.wadl.x2009.x02.MethodDocument.Method>
            {
                ...
                {
                    net.java.dev.wadl.x2009.x02.MethodDocument.Method old = ResourceImpl.this.getMethodArray(i);
        ...
        public java.util.List<net.java.dev.wadl.x2009.x02.ResourceDocument.Resource> getResourceList()
        {
            final class ResourceList extends java.util.AbstractList<net.java.dev.wadl.x2009.x02.ResourceDocument.Resource>
            {
                ...
                {
                    net.java.dev.wadl.x2009.x02.ResourceDocument.Resource old = ResourceImpl.this.getResourceArray(i);
         ...
         */
        public net.java.dev.wadl.x2009.x02.ResourceTypeList xgetType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                net.java.dev.wadl.x2009.x02.ResourceTypeList target = null;
                target = (net.java.dev.wadl.x2009.x02.ResourceTypeList)get_store().find_attribute_user(TYPE$10);
                return target;
            }
        }
         ...
         */
        public void xsetType(net.java.dev.wadl.x2009.x02.ResourceTypeList type)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (net.java.dev.wadl.x2009.x02.ResourceTypeList)get_store().add_attribute_user(TYPE$10);
                }
                target.set(type);
            }
        }
        ...
        public java.lang.String getQueryType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(QUERYTYPE$12);
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(QUERYTYPE$12);
                }
                if (target == null)
                {
                    return null;
         ...
         */
        public org.apache.xmlbeans.XmlString xgetQueryType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.XmlString target = null;
                target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(QUERYTYPE$12);
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlString)get_default_attribute_value(QUERYTYPE$12);
                }
                return target;
            }
        }
        ...
        public boolean isSetQueryType()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(QUERYTYPE$12) != null;
            }
        }
        ...
        public void setQueryType(java.lang.String queryType)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(QUERYTYPE$12);
                }
                target.setStringValue(queryType);
            }
        }
         ...
         */
        public void xsetQueryType(org.apache.xmlbeans.XmlString queryType)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(QUERYTYPE$12);
                }
        ...
        public void unsetQueryType()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(QUERYTYPE$12);
            }
        }
        ...
        public boolean isSetPath()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(PATH$14) != null;
            }
        }
