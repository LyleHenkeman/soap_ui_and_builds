...
public class KeyInfoTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x2000.x09.xmldsig.KeyInfoType
{
    ...
    {
        final class KeyNameList extends java.util.AbstractList<java.lang.String>
        {
            ...
            {
                java.lang.String old = KeyInfoTypeImpl.this.getKeyNameArray(i);
                KeyInfoTypeImpl.this.setKeyNameArray(i, o);
                return old;
            }
            
            public void add(int i, java.lang.String o)
                { KeyInfoTypeImpl.this.insertKeyName(i, o); }
    ...
    {
        final class KeyNameList extends java.util.AbstractList<org.apache.xmlbeans.XmlString>
        {
            ...
            {
                org.apache.xmlbeans.XmlString old = KeyInfoTypeImpl.this.xgetKeyNameArray(i);
                KeyInfoTypeImpl.this.xsetKeyNameArray(i, o);
                return old;
            }
            
            public void add(int i, org.apache.xmlbeans.XmlString o)
                { KeyInfoTypeImpl.this.insertNewKeyName(i).set(o); }
    ...
    {
        final class KeyValueList extends java.util.AbstractList<org.w3.x2000.x09.xmldsig.KeyValueType>
        {
            public org.w3.x2000.x09.xmldsig.KeyValueType get(int i)
                { return KeyInfoTypeImpl.this.getKeyValueArray(i); }
            
            public org.w3.x2000.x09.xmldsig.KeyValueType set(int i, org.w3.x2000.x09.xmldsig.KeyValueType o)
            {
                org.w3.x2000.x09.xmldsig.KeyValueType old = KeyInfoTypeImpl.this.getKeyValueArray(i);
                KeyInfoTypeImpl.this.setKeyValueArray(i, o);
                return old;
            }
            
            public void add(int i, org.w3.x2000.x09.xmldsig.KeyValueType o)
                { KeyInfoTypeImpl.this.insertNewKeyValue(i).set(o); }
            
            public org.w3.x2000.x09.xmldsig.KeyValueType remove(int i)
            {
                org.w3.x2000.x09.xmldsig.KeyValueType old = KeyInfoTypeImpl.this.getKeyValueArray(i);
    ...
    public org.w3.x2000.x09.xmldsig.KeyValueType[] getKeyValueArray()
    {
        ...
        {
            check_orphaned();
            java.util.List<org.w3.x2000.x09.xmldsig.KeyValueType> targetList = new java.util.ArrayList<org.w3.x2000.x09.xmldsig.KeyValueType>();
    ...
    {
        final class RetrievalMethodList extends java.util.AbstractList<org.w3.x2000.x09.xmldsig.RetrievalMethodType>
        {
            public org.w3.x2000.x09.xmldsig.RetrievalMethodType get(int i)
                { return KeyInfoTypeImpl.this.getRetrievalMethodArray(i); }
            
            public org.w3.x2000.x09.xmldsig.RetrievalMethodType set(int i, org.w3.x2000.x09.xmldsig.RetrievalMethodType o)
            {
                org.w3.x2000.x09.xmldsig.RetrievalMethodType old = KeyInfoTypeImpl.this.getRetrievalMethodArray(i);
                KeyInfoTypeImpl.this.setRetrievalMethodArray(i, o);
                return old;
            }
            
            public void add(int i, org.w3.x2000.x09.xmldsig.RetrievalMethodType o)
                { KeyInfoTypeImpl.this.insertNewRetrievalMethod(i).set(o); }
            
            public org.w3.x2000.x09.xmldsig.RetrievalMethodType remove(int i)
            {
                org.w3.x2000.x09.xmldsig.RetrievalMethodType old = KeyInfoTypeImpl.this.getRetrievalMethodArray(i);
        ...
        {
            check_orphaned();
            return new RetrievalMethodList();
        }
    }
    ...
    public org.w3.x2000.x09.xmldsig.RetrievalMethodType[] getRetrievalMethodArray()
    {
        ...
        {
            check_orphaned();
            java.util.List<org.w3.x2000.x09.xmldsig.RetrievalMethodType> targetList = new java.util.ArrayList<org.w3.x2000.x09.xmldsig.RetrievalMethodType>();
    ...
    {
        final class X509DataList extends java.util.AbstractList<org.w3.x2000.x09.xmldsig.X509DataType>
        {
            public org.w3.x2000.x09.xmldsig.X509DataType get(int i)
                { return KeyInfoTypeImpl.this.getX509DataArray(i); }
            
            public org.w3.x2000.x09.xmldsig.X509DataType set(int i, org.w3.x2000.x09.xmldsig.X509DataType o)
            {
                org.w3.x2000.x09.xmldsig.X509DataType old = KeyInfoTypeImpl.this.getX509DataArray(i);
                KeyInfoTypeImpl.this.setX509DataArray(i, o);
                return old;
            }
            
            public void add(int i, org.w3.x2000.x09.xmldsig.X509DataType o)
                { KeyInfoTypeImpl.this.insertNewX509Data(i).set(o); }
            
            public org.w3.x2000.x09.xmldsig.X509DataType remove(int i)
            {
                org.w3.x2000.x09.xmldsig.X509DataType old = KeyInfoTypeImpl.this.getX509DataArray(i);
    ...
    public org.w3.x2000.x09.xmldsig.X509DataType[] getX509DataArray()
    {
        ...
        {
            check_orphaned();
            java.util.List<org.w3.x2000.x09.xmldsig.X509DataType> targetList = new java.util.ArrayList<org.w3.x2000.x09.xmldsig.X509DataType>();
    ...
    {
        final class PGPDataList extends java.util.AbstractList<org.w3.x2000.x09.xmldsig.PGPDataType>
        {
            public org.w3.x2000.x09.xmldsig.PGPDataType get(int i)
                { return KeyInfoTypeImpl.this.getPGPDataArray(i); }
            
            public org.w3.x2000.x09.xmldsig.PGPDataType set(int i, org.w3.x2000.x09.xmldsig.PGPDataType o)
            {
                org.w3.x2000.x09.xmldsig.PGPDataType old = KeyInfoTypeImpl.this.getPGPDataArray(i);
                KeyInfoTypeImpl.this.setPGPDataArray(i, o);
                return old;
            }
            
            public void add(int i, org.w3.x2000.x09.xmldsig.PGPDataType o)
                { KeyInfoTypeImpl.this.insertNewPGPData(i).set(o); }
            
            public org.w3.x2000.x09.xmldsig.PGPDataType remove(int i)
            {
                org.w3.x2000.x09.xmldsig.PGPDataType old = KeyInfoTypeImpl.this.getPGPDataArray(i);
    ...
    public org.w3.x2000.x09.xmldsig.PGPDataType[] getPGPDataArray()
    {
        ...
        {
            check_orphaned();
            java.util.List<org.w3.x2000.x09.xmldsig.PGPDataType> targetList = new java.util.ArrayList<org.w3.x2000.x09.xmldsig.PGPDataType>();
    ...
    {
        final class SPKIDataList extends java.util.AbstractList<org.w3.x2000.x09.xmldsig.SPKIDataType>
        {
            public org.w3.x2000.x09.xmldsig.SPKIDataType get(int i)
                { return KeyInfoTypeImpl.this.getSPKIDataArray(i); }
            
            public org.w3.x2000.x09.xmldsig.SPKIDataType set(int i, org.w3.x2000.x09.xmldsig.SPKIDataType o)
            {
                org.w3.x2000.x09.xmldsig.SPKIDataType old = KeyInfoTypeImpl.this.getSPKIDataArray(i);
                KeyInfoTypeImpl.this.setSPKIDataArray(i, o);
                return old;
            }
            
            public void add(int i, org.w3.x2000.x09.xmldsig.SPKIDataType o)
                { KeyInfoTypeImpl.this.insertNewSPKIData(i).set(o); }
            
            public org.w3.x2000.x09.xmldsig.SPKIDataType remove(int i)
            {
                org.w3.x2000.x09.xmldsig.SPKIDataType old = KeyInfoTypeImpl.this.getSPKIDataArray(i);
    ...
    public org.w3.x2000.x09.xmldsig.SPKIDataType[] getSPKIDataArray()
    {
        ...
        {
            check_orphaned();
            java.util.List<org.w3.x2000.x09.xmldsig.SPKIDataType> targetList = new java.util.ArrayList<org.w3.x2000.x09.xmldsig.SPKIDataType>();
    ...
    {
        final class MgmtDataList extends java.util.AbstractList<java.lang.String>
        {
            public java.lang.String get(int i)
            ...
            public java.lang.String set(int i, java.lang.String o)
            {
                java.lang.String old = KeyInfoTypeImpl.this.getMgmtDataArray(i);
                KeyInfoTypeImpl.this.setMgmtDataArray(i, o);
                return old;
            }
            
            public void add(int i, java.lang.String o)
                { KeyInfoTypeImpl.this.insertMgmtData(i, o); }
    ...
    {
        final class MgmtDataList extends java.util.AbstractList<org.apache.xmlbeans.XmlString>
        {
            public org.apache.xmlbeans.XmlString get(int i)
            ...
            public org.apache.xmlbeans.XmlString set(int i, org.apache.xmlbeans.XmlString o)
            {
                org.apache.xmlbeans.XmlString old = KeyInfoTypeImpl.this.xgetMgmtDataArray(i);
                KeyInfoTypeImpl.this.xsetMgmtDataArray(i, o);
                return old;
            }
            
            public void add(int i, org.apache.xmlbeans.XmlString o)
                { KeyInfoTypeImpl.this.insertNewMgmtData(i).set(o); }
