 ...
 */
public class EnvelopeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x2003.x05.soapEnvelope.Envelope
{
    ...
    public org.w3.x2003.x05.soapEnvelope.Body getBody()
    {
        synchronized (monitor())
        {
            ...
            target = (org.w3.x2003.x05.soapEnvelope.Body)get_store().find_element_user(BODY$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setBody(org.w3.x2003.x05.soapEnvelope.Body body)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.w3.x2003.x05.soapEnvelope.Body)get_store().add_element_user(BODY$2);
            }
            target.set(body);
        }
    }
