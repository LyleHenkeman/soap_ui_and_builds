...
public class FaultImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.xmlsoap.schemas.soap.envelope.Fault
{
     ...
     */
    public org.xmlsoap.schemas.soap.envelope.FaultString getFaultstring()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.xmlsoap.schemas.soap.envelope.FaultString target = null;
            target = (org.xmlsoap.schemas.soap.envelope.FaultString)get_store().find_element_user(FAULTSTRING$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setFaultstring(org.xmlsoap.schemas.soap.envelope.FaultString faultstring)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.xmlsoap.schemas.soap.envelope.FaultString)get_store().add_element_user(FAULTSTRING$2);
            }
     ...
     */
    public org.xmlsoap.schemas.soap.envelope.FaultString addNewFaultstring()
    {
        synchronized (monitor())
        {
            check_orphaned();
