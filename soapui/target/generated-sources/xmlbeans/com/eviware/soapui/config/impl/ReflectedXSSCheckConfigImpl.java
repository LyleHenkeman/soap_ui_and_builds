 ...
 */
public class ReflectedXSSCheckConfigImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.eviware.soapui.config.ReflectedXSSCheckConfig
{
    private static final long serialVersionUID = 1L;
    
    public ReflectedXSSCheckConfigImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public java.util.List<java.lang.String> getParamToCheckList()
    {
        final class ParamToCheckList extends java.util.AbstractList<java.lang.String>
        {
            public java.lang.String get(int i)
                { return ReflectedXSSCheckConfigImpl.this.getParamToCheckArray(i); }
            
            public java.lang.String set(int i, java.lang.String o)
            {
                java.lang.String old = ReflectedXSSCheckConfigImpl.this.getParamToCheckArray(i);
                ReflectedXSSCheckConfigImpl.this.setParamToCheckArray(i, o);
                return old;
            }
            
            public void add(int i, java.lang.String o)
                { ReflectedXSSCheckConfigImpl.this.insertParamToCheck(i, o); }
            
            public java.lang.String remove(int i)
            {
                java.lang.String old = ReflectedXSSCheckConfigImpl.this.getParamToCheckArray(i);
                ReflectedXSSCheckConfigImpl.this.removeParamToCheck(i);
                return old;
            }
            
            public int size()
                { return ReflectedXSSCheckConfigImpl.this.sizeOfParamToCheckArray(); }
    ...
    public java.util.List<org.apache.xmlbeans.XmlString> xgetParamToCheckList()
    {
        final class ParamToCheckList extends java.util.AbstractList<org.apache.xmlbeans.XmlString>
        {
            public org.apache.xmlbeans.XmlString get(int i)
                { return ReflectedXSSCheckConfigImpl.this.xgetParamToCheckArray(i); }
            
            public org.apache.xmlbeans.XmlString set(int i, org.apache.xmlbeans.XmlString o)
            {
                org.apache.xmlbeans.XmlString old = ReflectedXSSCheckConfigImpl.this.xgetParamToCheckArray(i);
                ReflectedXSSCheckConfigImpl.this.xsetParamToCheckArray(i, o);
                return old;
            }
            
            public void add(int i, org.apache.xmlbeans.XmlString o)
                { ReflectedXSSCheckConfigImpl.this.insertNewParamToCheck(i).set(o); }
