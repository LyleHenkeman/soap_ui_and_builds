 ...
 */
public class MaliciousAttachmentSecurityCheckConfigImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.eviware.soapui.config.MaliciousAttachmentSecurityCheckConfig
{
    private static final long serialVersionUID = 1L;
    
    public MaliciousAttachmentSecurityCheckConfigImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public java.util.List<com.eviware.soapui.config.MaliciousAttachmentElementConfig> getElementList()
    {
        final class ElementList extends java.util.AbstractList<com.eviware.soapui.config.MaliciousAttachmentElementConfig>
        {
            public com.eviware.soapui.config.MaliciousAttachmentElementConfig get(int i)
                { return MaliciousAttachmentSecurityCheckConfigImpl.this.getElementArray(i); }
            ...
            {
                com.eviware.soapui.config.MaliciousAttachmentElementConfig old = MaliciousAttachmentSecurityCheckConfigImpl.this.getElementArray(i);
                MaliciousAttachmentSecurityCheckConfigImpl.this.setElementArray(i, o);
                return old;
            }
            
            public void add(int i, com.eviware.soapui.config.MaliciousAttachmentElementConfig o)
                { MaliciousAttachmentSecurityCheckConfigImpl.this.insertNewElement(i).set(o); }
            
            public com.eviware.soapui.config.MaliciousAttachmentElementConfig remove(int i)
            {
                com.eviware.soapui.config.MaliciousAttachmentElementConfig old = MaliciousAttachmentSecurityCheckConfigImpl.this.getElementArray(i);
                MaliciousAttachmentSecurityCheckConfigImpl.this.removeElement(i);
                return old;
            }
            
            public int size()
                { return MaliciousAttachmentSecurityCheckConfigImpl.this.sizeOfElementArray(); }
