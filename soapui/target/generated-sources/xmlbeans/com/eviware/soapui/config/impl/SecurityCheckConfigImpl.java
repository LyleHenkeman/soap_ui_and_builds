 ...
 */
public class SecurityCheckConfigImpl extends com.eviware.soapui.config.impl.ModelItemConfigImpl implements com.eviware.soapui.config.SecurityCheckConfig
{
    private static final long serialVersionUID = 1L;
    
    public SecurityCheckConfigImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName CHECKEDPAMETERS$6 = 
        new javax.xml.namespace.QName("http://eviware.com/soapui/config", "checkedPameters");
    private static final javax.xml.namespace.QName CHECKEDPARAMETERS$8 = 
        new javax.xml.namespace.QName("http://eviware.com/soapui/config", "checkedParameters");
    private static final javax.xml.namespace.QName EXECUTIONSTRATEGY$10 = 
    ...
    private static final javax.xml.namespace.QName APPLYFORFAILEDSTEP$14 = 
    ...
    public java.util.List<com.eviware.soapui.config.TestAssertionConfig> getAssertionList()
    {
        final class AssertionList extends java.util.AbstractList<com.eviware.soapui.config.TestAssertionConfig>
        {
            public com.eviware.soapui.config.TestAssertionConfig get(int i)
                { return SecurityCheckConfigImpl.this.getAssertionArray(i); }
            
            public com.eviware.soapui.config.TestAssertionConfig set(int i, com.eviware.soapui.config.TestAssertionConfig o)
            {
                com.eviware.soapui.config.TestAssertionConfig old = SecurityCheckConfigImpl.this.getAssertionArray(i);
                SecurityCheckConfigImpl.this.setAssertionArray(i, o);
                return old;
            }
            
            public void add(int i, com.eviware.soapui.config.TestAssertionConfig o)
                { SecurityCheckConfigImpl.this.insertNewAssertion(i).set(o); }
            
            public com.eviware.soapui.config.TestAssertionConfig remove(int i)
            {
                com.eviware.soapui.config.TestAssertionConfig old = SecurityCheckConfigImpl.this.getAssertionArray(i);
                SecurityCheckConfigImpl.this.removeAssertion(i);
                return old;
            }
            
            public int size()
                { return SecurityCheckConfigImpl.this.sizeOfAssertionArray(); }
     ...
     */
    public com.eviware.soapui.config.CheckedParametersListConfig getCheckedPameters()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.eviware.soapui.config.CheckedParametersListConfig target = null;
            target = (com.eviware.soapui.config.CheckedParametersListConfig)get_store().find_element_user(CHECKEDPAMETERS$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCheckedPameters(com.eviware.soapui.config.CheckedParametersListConfig checkedPameters)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.eviware.soapui.config.CheckedParametersListConfig)get_store().add_element_user(CHECKEDPAMETERS$6);
            }
            target.set(checkedPameters);
        }
    }
     ...
     */
    public com.eviware.soapui.config.CheckedParametersListConfig addNewCheckedPameters()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public com.eviware.soapui.config.CheckedParametersListConfig getCheckedParameters()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.eviware.soapui.config.CheckedParametersListConfig target = null;
            target = (com.eviware.soapui.config.CheckedParametersListConfig)get_store().find_element_user(CHECKEDPARAMETERS$8, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setCheckedParameters(com.eviware.soapui.config.CheckedParametersListConfig checkedParameters)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.eviware.soapui.config.CheckedParametersListConfig)get_store().add_element_user(CHECKEDPARAMETERS$8);
            }
    ...
    public com.eviware.soapui.config.ExecutionStrategyConfig getExecutionStrategy()
    {
        synchronized (monitor())
        {
            ...
            target = (com.eviware.soapui.config.ExecutionStrategyConfig)get_store().find_element_user(EXECUTIONSTRATEGY$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setExecutionStrategy(com.eviware.soapui.config.ExecutionStrategyConfig executionStrategy)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.eviware.soapui.config.ExecutionStrategyConfig)get_store().add_element_user(EXECUTIONSTRATEGY$10);
            }
    ...
    public boolean getApplyForFailedStep()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(APPLYFORFAILEDSTEP$14);
            if (target == null)
            {
                return false;
            }
    ...
    public org.apache.xmlbeans.XmlBoolean xgetApplyForFailedStep()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlBoolean)get_store().find_attribute_user(APPLYFORFAILEDSTEP$14);
            return target;
        }
    }
    ...
    public boolean isSetApplyForFailedStep()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(APPLYFORFAILEDSTEP$14) != null;
        }
    }
    ...
    public void setApplyForFailedStep(boolean applyForFailedStep)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(APPLYFORFAILEDSTEP$14);
            }
    ...
    public void xsetApplyForFailedStep(org.apache.xmlbeans.XmlBoolean applyForFailedStep)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_store().add_attribute_user(APPLYFORFAILEDSTEP$14);
            }
    ...
    public void unsetApplyForFailedStep()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(APPLYFORFAILEDSTEP$14);
        }
    }
