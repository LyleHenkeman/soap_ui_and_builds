 ...
 */
public class CrossSiteScriptingScanConfigImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.eviware.soapui.config.CrossSiteScriptingScanConfig
{
    private static final long serialVersionUID = 1L;
    
    public CrossSiteScriptingScanConfigImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public java.util.List<java.lang.String> getParameterExposureStringsList()
    {
        final class ParameterExposureStringsList extends java.util.AbstractList<java.lang.String>
        {
            public java.lang.String get(int i)
                { return CrossSiteScriptingScanConfigImpl.this.getParameterExposureStringsArray(i); }
            
            public java.lang.String set(int i, java.lang.String o)
            {
                java.lang.String old = CrossSiteScriptingScanConfigImpl.this.getParameterExposureStringsArray(i);
                CrossSiteScriptingScanConfigImpl.this.setParameterExposureStringsArray(i, o);
                return old;
            }
            
            public void add(int i, java.lang.String o)
                { CrossSiteScriptingScanConfigImpl.this.insertParameterExposureStrings(i, o); }
            
            public java.lang.String remove(int i)
            {
                java.lang.String old = CrossSiteScriptingScanConfigImpl.this.getParameterExposureStringsArray(i);
                CrossSiteScriptingScanConfigImpl.this.removeParameterExposureStrings(i);
                return old;
            }
            
            public int size()
                { return CrossSiteScriptingScanConfigImpl.this.sizeOfParameterExposureStringsArray(); }
    ...
    public java.util.List<org.apache.xmlbeans.XmlString> xgetParameterExposureStringsList()
    {
        final class ParameterExposureStringsList extends java.util.AbstractList<org.apache.xmlbeans.XmlString>
        {
            public org.apache.xmlbeans.XmlString get(int i)
                { return CrossSiteScriptingScanConfigImpl.this.xgetParameterExposureStringsArray(i); }
            
            public org.apache.xmlbeans.XmlString set(int i, org.apache.xmlbeans.XmlString o)
            {
                org.apache.xmlbeans.XmlString old = CrossSiteScriptingScanConfigImpl.this.xgetParameterExposureStringsArray(i);
                CrossSiteScriptingScanConfigImpl.this.xsetParameterExposureStringsArray(i, o);
                return old;
            }
            
            public void add(int i, org.apache.xmlbeans.XmlString o)
                { CrossSiteScriptingScanConfigImpl.this.insertNewParameterExposureStrings(i).set(o); }
