 ...
 */
public class SQLInjectionScanConfigImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.eviware.soapui.config.SQLInjectionScanConfig
{
    private static final long serialVersionUID = 1L;
    
    public SQLInjectionScanConfigImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public java.util.List<java.lang.String> getSqlInjectionStringsList()
    {
        final class SqlInjectionStringsList extends java.util.AbstractList<java.lang.String>
        {
            public java.lang.String get(int i)
                { return SQLInjectionScanConfigImpl.this.getSqlInjectionStringsArray(i); }
            
            public java.lang.String set(int i, java.lang.String o)
            {
                java.lang.String old = SQLInjectionScanConfigImpl.this.getSqlInjectionStringsArray(i);
                SQLInjectionScanConfigImpl.this.setSqlInjectionStringsArray(i, o);
                return old;
            }
            
            public void add(int i, java.lang.String o)
                { SQLInjectionScanConfigImpl.this.insertSqlInjectionStrings(i, o); }
            
            public java.lang.String remove(int i)
            {
                java.lang.String old = SQLInjectionScanConfigImpl.this.getSqlInjectionStringsArray(i);
                SQLInjectionScanConfigImpl.this.removeSqlInjectionStrings(i);
                return old;
            }
            
            public int size()
                { return SQLInjectionScanConfigImpl.this.sizeOfSqlInjectionStringsArray(); }
    ...
    public java.util.List<org.apache.xmlbeans.XmlString> xgetSqlInjectionStringsList()
    {
        final class SqlInjectionStringsList extends java.util.AbstractList<org.apache.xmlbeans.XmlString>
        {
            public org.apache.xmlbeans.XmlString get(int i)
                { return SQLInjectionScanConfigImpl.this.xgetSqlInjectionStringsArray(i); }
            
            public org.apache.xmlbeans.XmlString set(int i, org.apache.xmlbeans.XmlString o)
            {
                org.apache.xmlbeans.XmlString old = SQLInjectionScanConfigImpl.this.xgetSqlInjectionStringsArray(i);
                SQLInjectionScanConfigImpl.this.xsetSqlInjectionStringsArray(i, o);
                return old;
            }
            
            public void add(int i, org.apache.xmlbeans.XmlString o)
                { SQLInjectionScanConfigImpl.this.insertNewSqlInjectionStrings(i).set(o); }
