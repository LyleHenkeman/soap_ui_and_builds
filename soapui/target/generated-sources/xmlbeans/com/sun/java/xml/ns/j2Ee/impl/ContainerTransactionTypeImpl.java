 ...
 */
public class ContainerTransactionTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.sun.java.xml.ns.j2Ee.ContainerTransactionType
{
    private static final long serialVersionUID = 1L;
    
    public ContainerTransactionTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName TRANSATTRIBUTE$4 = 
        new javax.xml.namespace.QName("http://java.sun.com/xml/ns/j2ee", "trans-attribute");
    ...
    public java.util.List<com.sun.java.xml.ns.j2Ee.DescriptionType> getDescriptionList()
    {
        final class DescriptionList extends java.util.AbstractList<com.sun.java.xml.ns.j2Ee.DescriptionType>
        {
            public com.sun.java.xml.ns.j2Ee.DescriptionType get(int i)
                { return ContainerTransactionTypeImpl.this.getDescriptionArray(i); }
            
            public com.sun.java.xml.ns.j2Ee.DescriptionType set(int i, com.sun.java.xml.ns.j2Ee.DescriptionType o)
            {
                com.sun.java.xml.ns.j2Ee.DescriptionType old = ContainerTransactionTypeImpl.this.getDescriptionArray(i);
                ContainerTransactionTypeImpl.this.setDescriptionArray(i, o);
                return old;
            }
            
            public void add(int i, com.sun.java.xml.ns.j2Ee.DescriptionType o)
                { ContainerTransactionTypeImpl.this.insertNewDescription(i).set(o); }
            
            public com.sun.java.xml.ns.j2Ee.DescriptionType remove(int i)
            {
                com.sun.java.xml.ns.j2Ee.DescriptionType old = ContainerTransactionTypeImpl.this.getDescriptionArray(i);
                ContainerTransactionTypeImpl.this.removeDescription(i);
                return old;
            }
            
            public int size()
                { return ContainerTransactionTypeImpl.this.sizeOfDescriptionArray(); }
    ...
    public java.util.List<com.sun.java.xml.ns.j2Ee.MethodType> getMethodList()
    {
        final class MethodList extends java.util.AbstractList<com.sun.java.xml.ns.j2Ee.MethodType>
        {
            public com.sun.java.xml.ns.j2Ee.MethodType get(int i)
                { return ContainerTransactionTypeImpl.this.getMethodArray(i); }
            
            public com.sun.java.xml.ns.j2Ee.MethodType set(int i, com.sun.java.xml.ns.j2Ee.MethodType o)
            {
                com.sun.java.xml.ns.j2Ee.MethodType old = ContainerTransactionTypeImpl.this.getMethodArray(i);
                ContainerTransactionTypeImpl.this.setMethodArray(i, o);
                return old;
            }
            
            public void add(int i, com.sun.java.xml.ns.j2Ee.MethodType o)
                { ContainerTransactionTypeImpl.this.insertNewMethod(i).set(o); }
            
            public com.sun.java.xml.ns.j2Ee.MethodType remove(int i)
            {
                com.sun.java.xml.ns.j2Ee.MethodType old = ContainerTransactionTypeImpl.this.getMethodArray(i);
                ContainerTransactionTypeImpl.this.removeMethod(i);
                return old;
            }
            
            public int size()
                { return ContainerTransactionTypeImpl.this.sizeOfMethodArray(); }
     ...
     */
    public com.sun.java.xml.ns.j2Ee.TransAttributeType getTransAttribute()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sun.java.xml.ns.j2Ee.TransAttributeType target = null;
            target = (com.sun.java.xml.ns.j2Ee.TransAttributeType)get_store().find_element_user(TRANSATTRIBUTE$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTransAttribute(com.sun.java.xml.ns.j2Ee.TransAttributeType transAttribute)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sun.java.xml.ns.j2Ee.TransAttributeType)get_store().add_element_user(TRANSATTRIBUTE$4);
            }
            target.set(transAttribute);
        }
    }
     ...
     */
    public com.sun.java.xml.ns.j2Ee.TransAttributeType addNewTransAttribute()
    {
        synchronized (monitor())
        {
            check_orphaned();
