 ...
 */
public class EjbRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.sun.java.xml.ns.j2Ee.EjbRefType
{
    ...
    public java.util.List<com.sun.java.xml.ns.j2Ee.DescriptionType> getDescriptionList()
    {
        final class DescriptionList extends java.util.AbstractList<com.sun.java.xml.ns.j2Ee.DescriptionType>
        {
            ...
            {
                com.sun.java.xml.ns.j2Ee.DescriptionType old = EjbRefTypeImpl.this.getDescriptionArray(i);
    ...
    public com.sun.java.xml.ns.j2Ee.HomeType getHome()
    {
        synchronized (monitor())
        {
            ...
            target = (com.sun.java.xml.ns.j2Ee.HomeType)get_store().find_element_user(HOME$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setHome(com.sun.java.xml.ns.j2Ee.HomeType home)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.sun.java.xml.ns.j2Ee.HomeType)get_store().add_element_user(HOME$6);
            }
            target.set(home);
        }
    }
    ...
    public com.sun.java.xml.ns.j2Ee.RemoteType getRemote()
    {
        synchronized (monitor())
        {
            ...
            target = (com.sun.java.xml.ns.j2Ee.RemoteType)get_store().find_element_user(REMOTE$8, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setRemote(com.sun.java.xml.ns.j2Ee.RemoteType remote)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.sun.java.xml.ns.j2Ee.RemoteType)get_store().add_element_user(REMOTE$8);
            }
            target.set(remote);
        }
    }
