 ...
 */
public class UserDataConstraintTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.sun.java.xml.ns.j2Ee.UserDataConstraintType
{
    private static final long serialVersionUID = 1L;
    
    public UserDataConstraintTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName TRANSPORTGUARANTEE$2 = 
        new javax.xml.namespace.QName("http://java.sun.com/xml/ns/j2ee", "transport-guarantee");
    ...
    public java.util.List<com.sun.java.xml.ns.j2Ee.DescriptionType> getDescriptionList()
    {
        final class DescriptionList extends java.util.AbstractList<com.sun.java.xml.ns.j2Ee.DescriptionType>
        {
            public com.sun.java.xml.ns.j2Ee.DescriptionType get(int i)
                { return UserDataConstraintTypeImpl.this.getDescriptionArray(i); }
            
            public com.sun.java.xml.ns.j2Ee.DescriptionType set(int i, com.sun.java.xml.ns.j2Ee.DescriptionType o)
            {
                com.sun.java.xml.ns.j2Ee.DescriptionType old = UserDataConstraintTypeImpl.this.getDescriptionArray(i);
                UserDataConstraintTypeImpl.this.setDescriptionArray(i, o);
                return old;
            }
            
            public void add(int i, com.sun.java.xml.ns.j2Ee.DescriptionType o)
                { UserDataConstraintTypeImpl.this.insertNewDescription(i).set(o); }
            
            public com.sun.java.xml.ns.j2Ee.DescriptionType remove(int i)
            {
                com.sun.java.xml.ns.j2Ee.DescriptionType old = UserDataConstraintTypeImpl.this.getDescriptionArray(i);
                UserDataConstraintTypeImpl.this.removeDescription(i);
                return old;
            }
            
            public int size()
                { return UserDataConstraintTypeImpl.this.sizeOfDescriptionArray(); }
     ...
     */
    public com.sun.java.xml.ns.j2Ee.TransportGuaranteeType getTransportGuarantee()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sun.java.xml.ns.j2Ee.TransportGuaranteeType target = null;
            target = (com.sun.java.xml.ns.j2Ee.TransportGuaranteeType)get_store().find_element_user(TRANSPORTGUARANTEE$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTransportGuarantee(com.sun.java.xml.ns.j2Ee.TransportGuaranteeType transportGuarantee)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sun.java.xml.ns.j2Ee.TransportGuaranteeType)get_store().add_element_user(TRANSPORTGUARANTEE$2);
            }
     ...
     */
    public com.sun.java.xml.ns.j2Ee.TransportGuaranteeType addNewTransportGuarantee()
    {
        synchronized (monitor())
        {
            check_orphaned();
