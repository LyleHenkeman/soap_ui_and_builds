 ...
 */
public class FilterTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.sun.java.xml.ns.j2Ee.FilterType
{
    ...
    private static final javax.xml.namespace.QName FILTERCLASS$8 = 
        new javax.xml.namespace.QName("http://java.sun.com/xml/ns/j2ee", "filter-class");
    ...
    public java.util.List<com.sun.java.xml.ns.j2Ee.DescriptionType> getDescriptionList()
    {
        final class DescriptionList extends java.util.AbstractList<com.sun.java.xml.ns.j2Ee.DescriptionType>
        {
            ...
            {
                com.sun.java.xml.ns.j2Ee.DescriptionType old = FilterTypeImpl.this.getDescriptionArray(i);
    ...
    public java.util.List<com.sun.java.xml.ns.j2Ee.DisplayNameType> getDisplayNameList()
    {
        final class DisplayNameList extends java.util.AbstractList<com.sun.java.xml.ns.j2Ee.DisplayNameType>
        {
            ...
            {
                com.sun.java.xml.ns.j2Ee.DisplayNameType old = FilterTypeImpl.this.getDisplayNameArray(i);
    ...
    public java.util.List<com.sun.java.xml.ns.j2Ee.IconType> getIconList()
    {
        final class IconList extends java.util.AbstractList<com.sun.java.xml.ns.j2Ee.IconType>
        {
            ...
            {
                com.sun.java.xml.ns.j2Ee.IconType old = FilterTypeImpl.this.getIconArray(i);
    ...
    public com.sun.java.xml.ns.j2Ee.FilterNameType getFilterName()
    {
        synchronized (monitor())
        {
            ...
            target = (com.sun.java.xml.ns.j2Ee.FilterNameType)get_store().find_element_user(FILTERNAME$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setFilterName(com.sun.java.xml.ns.j2Ee.FilterNameType filterName)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.sun.java.xml.ns.j2Ee.FilterNameType)get_store().add_element_user(FILTERNAME$6);
            }
     ...
     */
    public com.sun.java.xml.ns.j2Ee.FullyQualifiedClassType getFilterClass()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sun.java.xml.ns.j2Ee.FullyQualifiedClassType target = null;
            target = (com.sun.java.xml.ns.j2Ee.FullyQualifiedClassType)get_store().find_element_user(FILTERCLASS$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setFilterClass(com.sun.java.xml.ns.j2Ee.FullyQualifiedClassType filterClass)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sun.java.xml.ns.j2Ee.FullyQualifiedClassType)get_store().add_element_user(FILTERCLASS$8);
            }
     ...
     */
    public com.sun.java.xml.ns.j2Ee.FullyQualifiedClassType addNewFilterClass()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public java.util.List<com.sun.java.xml.ns.j2Ee.ParamValueType> getInitParamList()
    {
        final class InitParamList extends java.util.AbstractList<com.sun.java.xml.ns.j2Ee.ParamValueType>
        {
            ...
            {
                com.sun.java.xml.ns.j2Ee.ParamValueType old = FilterTypeImpl.this.getInitParamArray(i);
